...
public class GameCanvas extends JPanel implements ActionListener{
    ...
    public void pitch(int direction) {
		if(changingYDirection) {
			ship.rotate_square(1, 0, 0, direction*angle);
		}
    }
	...
	private void construct_ship() {
		...
		Point3D p1 = new Point3D(-sqrSideLength/4,-sqrSideLength/4,-sqrSideLength/4);
		Point3D p2 = new Point3D(sqrSideLength/4,-sqrSideLength/4,-sqrSideLength/4);
		Point3D p3 = new Point3D(sqrSideLength/4,sqrSideLength/4,-sqrSideLength/4);
		Point3D p4 = new Point3D(-sqrSideLength/4,sqrSideLength/4,-sqrSideLength/4);
		 
		Point3D p5 = new Point3D(-sqrSideLength/4,-sqrSideLength/4,sqrSideLength/4);
		Point3D p6 = new Point3D(sqrSideLength/4,-sqrSideLength/4,sqrSideLength/4);
		Point3D p7 = new Point3D(sqrSideLength/4,sqrSideLength/4,sqrSideLength/4);
		Point3D p8 = new Point3D(-sqrSideLength/4,sqrSideLength/4,sqrSideLength/4);
		
		Point3D pwp = new Point3D(2*sqrSideLength,0,0);
		Point3D pwn = new Point3D(-2*sqrSideLength,0,0);
		Point3D pf = new Point3D(0,-sqrSideLength*.75,0);
